export const WORKFLOW_TEMPLATES = [
  ...
  },
  {
    ...
    browserPrompt: ({ task, user }) => [
      ...
      "If the user request contains 'Navigate directly to: <url>', open that URL first — it skips re-searching. Otherwise open https://www.ubereats.com/ directly.",
      ...
      "If no direct URL was provided, search for the named restaurant on UberEats and navigate to its menu.",
